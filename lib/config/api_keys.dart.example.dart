...
// Удален неиспользуемый импорт dart:io
class ApiKeys {
  ...
  static bool get hasWeatherKey =>
      weatherApiKey.isNotEmpty && !weatherApiKey.contains('YOUR_');
  ...
  static bool get hasFirebaseKey =>
      firebaseApiKey.isNotEmpty && !firebaseApiKey.contains('YOUR_');

  static bool get hasYouTubeKey =>
      youtubeApiKey.isNotEmpty && !youtubeApiKey.contains('YOUR_');
