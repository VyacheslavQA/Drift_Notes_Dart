// Путь: lib/screens/bait_programs/add_bait_program_screen.dart
...
class AddBaitProgramScreen extends StatefulWidget {
  const AddBaitProgramScreen({super.key});

  @override
  State<AddBaitProgramScreen> createState() => _AddBaitProgramScreenState();
}

class _AddBaitProgramScreenState extends State<AddBaitProgramScreen> {
  ...
  Future<void> _saveProgram() async {
    ...
    try {
      final program = BaitProgramModel(
        id: '',
        userId: '',
      ...
      await _repository.addBaitProgram(program);
  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          title: Text(
            localizations.translate('new_bait_program'),
            style: TextStyle(
              color: AppConstants.textColor,
