...
void _budgetNoteEntitySerialize(
  ...
  writer.writeLong(offsets[4], object.expenseCount);
  writer.writeString(offsets[5], object.expensesJson);
  writer.writeString(offsets[6], object.firebaseId);
  writer.writeBool(offsets[7], object.isMultiDay);
  writer.writeBool(offsets[8], object.isSynced);
  writer.writeDateTime(offsets[9], object.lastSyncAt);
  writer.writeString(offsets[10], object.locationName);
  writer.writeBool(offsets[11], object.markedForDeletion);
...
BudgetNoteEntity _budgetNoteEntityDeserialize(
  ...
  object.expenseCount = reader.readLong(offsets[4]);
  object.expensesJson = reader.readString(offsets[5]);
  object.firebaseId = reader.readStringOrNull(offsets[6]);
  object.id = id;
  object.isMultiDay = reader.readBool(offsets[7]);
  object.isSynced = reader.readBool(offsets[8]);
  object.lastSyncAt = reader.readDateTimeOrNull(offsets[9]);
  object.locationName = reader.readStringOrNull(offsets[10]);
  object.markedForDeletion = reader.readBool(offsets[11]);
...
extension BudgetNoteEntityQueryProperty
  ...
  QueryBuilder<BudgetNoteEntity, String, QQueryOperations> currencyProperty() {
    return QueryBuilder.apply(this, (query) {
